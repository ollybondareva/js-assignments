...
function extractNameFromTemplate(value) {
    return value.replace(/Hello, ([A-za-z]+) ([A-za-z]+)!/, '$1 $2');
}
        ...
        if ((currentCharCode >= 65 && currentCharCode <= 90) || (currentCharCode >= 97 && currentCharCode <= 122)) {
            if (currentCharCode >= 65 && currentCharCode <= 90) {
                if (newCharCode <= 90) {
                    ...
                    let startNewCharCode = 64 + newCharCode - 90;
                    newStr += String.fromCharCode(startNewCharCode);
                }
            }
            if (currentCharCode >= 97 && currentCharCode <= 122) {
                if (newCharCode <= 122) {
                    ...
                    let startNewCharCode = 96 + newCharCode - 122;
                    newStr += String.fromCharCode(startNewCharCode);
                }
            }
        } else {
